...
%
\Title{Features that regulate terminator \\
  strength in plants}
\Author{Sayeh Gorjifard}
\Year{2023}
\Program{Genome Sciences}

\Chair{Christine Queitsch}{Title of Chair}{Genome Sciences}
\Signature{Stanley Fields}
\Signature{Phil Green}
\Signature{etc}
